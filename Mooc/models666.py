...
class Courselist(models.Model):
    ...
    webuser = models.CharField(db_column='webUser', max_length=20)  # Field name made lowercase.
    coursedbname = models.CharField(db_column='courseDBName', max_length=100)  # Field name made lowercase.
...
class Webuser(models.Model):
    ...
    isvalid = models.CharField(max_length=45)
    valid_code = models.CharField(max_length=45)
